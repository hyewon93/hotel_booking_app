...
const GuestInfoForm = ({ hotelId, pricePerNight }: Props) => {
    ...
    return (
        <div className="flex flex-col p-4 bg-sky-200 gap-4 rounded-sm">
            ...
            <form onSubmit={isLoggedIn ? handleSubmit(onSubmit) : handleSubmit(onSignInClick)}>
                <div className="grid grid-cols-1 gap-4 items-center">
                    ...
                    {isLoggedIn 
                        ? (
                            <button className="bg-sky-600 text-white h-full p-2 font-bold text-xl rounded hover:bg-sky-500">
                                Book Now
                            </button>
                        ) : (
                            <button className="bg-sky-600 text-white h-full p-2 font-bold text-xl rounded hover:bg-sky-500">
